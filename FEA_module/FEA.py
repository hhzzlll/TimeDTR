...
from FEA_module.S4Model import S4Layer
...
class FEA(nn.Module):
    def __init__(self, in_channels, res_channels, skip_channels, out_channels, 
        ...
        self.final_conv = Conv(skip_channels, out_channels, kernel_size=1)
        self.linear_layer = nn.Linear(y_len,pred_len)
                                

    def forward(self, input_data, pred_len):
        
        x_0, conditional, mask, diffusion_steps = input_data 
